insert into users (first_name, last_name, pwd, username) values ('Delilah', 'Hanwell', 'k3xk63JD6f83', 'dhanwell0');
insert into users (first_name, last_name, pwd, username) values ('Ronny', 'McEvoy', 'yxjZFhhwUe', 'rmcevoy1');
insert into users (first_name, last_name, pwd, username) values ('Franciska', 'Comiskey', '8vnW5OCGgd', 'fcomiskey2');
insert into users (first_name, last_name, pwd, username) values ('Lexy', 'Charsley', 'b4i3hgavGw', 'lcharsley3');
insert into users (first_name, last_name, pwd, username) values ('Emmett', 'Bercevelo', '5XZI3KWCFi', 'ebercevelo4');
insert into users (first_name, last_name, pwd, username) values ('Susy', 'Dedon', 'IKWKljOVs', 'sdedon5');
insert into users (first_name, last_name, pwd, username) values ('Skipp', 'Wrankling', 'gp8Pyt', 'swrankling6');
...
insert into leaderboard (date_played, game_name, points, time_completed, won, user_id) values ('01/10/2021', 'war', 50, '12:16:22 AM', true, 5);
insert into leaderboard (date_played, game_name, points, time_completed, won, user_id) values ('12/28/2020', 'war', 83, '10:00:52 AM', true, 5);
...
insert into leaderboard (date_played, game_name, points, time_completed, won, user_id) values ('07/07/2021', 'speed', 10, '1:13:30 AM', false, 7);
